...
class CitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'cities_ibfk_1' => ['type' => 'foreign', 'columns' => ['state_id'], 'references' => ['states', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'parent_id' => 1,
            'state_id' => 1,
            'created' => '2015-07-15 10:38:10',
            'modified' => '2015-07-15 10:38:10'
        ],
    ];
}
